...
free. Desktop users, download the google chrome extension by going to metamask.io.`,
  },
  {
    ...
    paragraph: `have ETH in your wallet to switch to $PEPINA. If you don’t have any ETH, you can buy directly on metamask, transfer from another wallet, or buy on another exchange and send it to
        your wallet.`,
  },
  {
    image: howtobuy3,
    heading: "Go to Uniswap",
    paragraph: `connect to Uniswap. Go to app.uniswap.org in google chrome or on the browser inside your Metamask app. Connect your wallet. Paste the $PEPINA token address into Uniswap, select
$PEPINA, and confirm. When Metamask prompts you for a wallet signature, sign.`,
  },
  {
    image: howtobuy4,
    heading: "Switch ETH for $PEPINA",
    paragraph: `switch ETH for $PEPINA. We have ZERO taxes so you don’t need to worry about buying with a specific slippage, although you may need to use slippage during times of market volatility.`,
  },
];
    ...
    <>
      <div className=" py-5 md:w-[80%] w-[90%] mx-auto">
          ...
          {CardData.map((items, index) => {
            return (
              <>
                <div
                  key={index}
                  className="border-2 border-[#fffef8] bg-[#264B20] py-4  rounded-tr-[30px] rounded-bl-[30px] md:px-4 px-1 flex justify-center items-center  transition ease-in-out delay-200 my-4 md:flex-row flex-col hover:bg-bgcolor"
                >
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 my-8">
          <div className="iframdiv border-2 overflow-scroll h-[70vh] my-auto">
            {/* <div className="bg-[#171517] rounded-[10px] py-4 px-8 md:w-[100%] w-full">
