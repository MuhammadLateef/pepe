...
const Tokenomic = () => {
  return (
    <>
      <div className="my-8 py-4 text-[#ffff] w-[85%] mx-auto">
        <h2
        ...
        <div className="flex md:flex-row flex-col justify-between items-center my-10 gap-10 ">
          <div
          ...
          >
            ...
            <p className="sm:text-[20px] text-[16px] mt-3 text-center text1">420,690,000,000,000</p>
          ...
          <div className="md:w-[35%] w-full p-8 mx-auto my-auto">
