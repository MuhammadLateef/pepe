...
const NavbarItems = ({ title, classProps }) => {
  return (
    <li
      className={` cursor-pointer  transition duration-300 hover:text-textcolor text-white text1 text-[10px] ${classProps}`}
    >
      {title}
    </li>
  );
  ...
  return (
    <>
      <nav className="bg-bgcolor ">
        <div className="flex p-5 md:p-10 lg:px-20 md:px-0 w-[100%] lg:justify-between md:border-b-2 border-b-0  border-black items-center self-stretch md:shadow-lg shadow-0 sticky top-0">
          ...
          <div className="md:block hidden">
            <ul className="flex justify-end items-center lg:gap-8 md:gap-2  text-black ">
